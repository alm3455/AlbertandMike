        ...
        for i in range (3):
            ...
            for wrapper in soup.find_all('div', attrs={'class': 'item_wrap'}):
                ...
                try:
                    ...
                    writer.writerow([item_name, i, serving_size, calories, calories_from_fat, total_fat, saturated_fat, trans_fat, cholesterol, sodium, total_carbs, dietary_fiber, sugars, protein])
                except:
                    print ("invalid data")
